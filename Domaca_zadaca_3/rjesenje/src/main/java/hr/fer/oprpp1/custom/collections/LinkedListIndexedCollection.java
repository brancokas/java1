...
/**
 * class <code>LinkedListIndexedCollection</code> implements 
 * resizable array-backed collection of objects of type T
 * 
...
public class LinkedListIndexedCollection<T> implements List<T> {
	...
	private static class ElementsGetterClass<T> implements ElementsGetter<T> {
		...
		public ElementsGetterClass(LinkedListIndexedCollection<T> list, long modificationCount) {
			this.list = list;
			this.currNode = list.first;
